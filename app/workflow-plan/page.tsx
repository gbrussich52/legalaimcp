...
export default function WorkflowPlanPage() {
  return (
    <main className="max-w-6xl mx-auto px-6 py-12 sm:py-16">
      ...
      <p className="text-sm text-charcoal/70 mt-4">Planning a document workflow? <Link className="text-gold-text font-semibold underline" href="/document-check">Try the fictional document check demo →</Link></p>
      <WorkflowPlanner />
    </main>
  )
}
