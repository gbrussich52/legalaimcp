    ...
    <main>
      ...
      <section id="checker" className="bg-warm-white px-6 py-16 scroll-mt-16">
        <div className="max-w-6xl mx-auto">
          <div className="max-w-2xl">
            ...
            <p className="text-charcoal/75 mt-4 leading-relaxed">Change names, periods, versions, pages, and associations to see how the review list changes. This demo checks metadata only. It does not read files or decide whether a legal document is sufficient.</p>
          </div>
          <section className="mt-8 border border-slate-200 rounded-xl bg-white p-5 sm:p-6" aria-labelledby="example-heading">
            ...
            <div className="grid sm:grid-cols-2 gap-5 mt-5 text-sm">
              <div><p className="font-semibold text-navy">Before</p><p className="mt-1 text-charcoal/75">3 requested records: a deed, a lease, and an identity statement.</p></div>
              <div><p className="font-semibold text-navy">After</p><p className="mt-1 text-charcoal/75">4 received entries: an old deed, two lease copies, and one unassigned scan.</p></div>
            </div>
      ...
      <section className="bg-white border-t border-slate-200 px-6 py-16">
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          <div><h2 className="font-display text-xl font-bold text-navy">Start with one checklist</h2><p className="mt-3 text-sm text-charcoal/75 leading-relaxed">Choose one repeatable request and define what “ready for review” means to your team.</p></div>
          <div><h2 className="font-display text-xl font-bold text-navy">Keep the examples safe</h2><p className="mt-3 text-sm text-charcoal/75 leading-relaxed">Use redacted or fictional records while you learn where staff judgment is still needed.</p></div>
          <div><h2 className="font-display text-xl font-bold text-navy">Scope the next step</h2><p className="mt-3 text-sm text-charcoal/75 leading-relaxed">Bring the demo result to a free fit call. Any paid scope and fee is agreed in writing first.</p></div>
        </div>
      </section>
    </main>
  )
